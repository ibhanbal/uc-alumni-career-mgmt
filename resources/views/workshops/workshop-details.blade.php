...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-8">
      <img style="width: 755px; height: 480px;" src="{{ asset('images/workshop-images/' . $workshop->image_url) }}" alt="{{ url('https://drive.google.com/file/d/1RVZutLWjx-sPVEMok_wHVlDk3coJ_CCB/view?usp=sharing') }}">
    </div>
  </div>
  <div class="row mt-60">
