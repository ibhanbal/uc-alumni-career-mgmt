  ...
  <div class="container">
    <div class="row pt-30">
      <form id="create_resume" name="create_resume" method="POST" action="{{ url('/resume') }}">
        ...
        <br />
        <div class="form-group">
          <a href="{{ url('/resume') }}"><button type="submit" class="btn btn-flat btn-theme-colored text-uppercase mt-10 mb-sm-30 border-left-theme-color-2-4px">Generate Resume</button></a>
